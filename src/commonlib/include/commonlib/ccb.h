...
/*
 * CCB - Coreboot Control Block
 *
 * This is a small block of settings loaded as part of bootblock. It can be
 * updated without rebuilding coreboot. It is intended to control simple things
 * like the serial console and logging.
 */
